document.addEventListener("DOMContentLoaded", () => {
  ...
  const intervalId = setInterval(function () {
    ...
    if (quiz.timeRemaining > 0) {
      timeRemainingContainer.innerHTML = `Time remaining: ${minutes}:${seconds}`;
    } else {
      timeRemainingContainer.innerHTML = "Time's Up!";
  ...
  function showQuestion() {
    ...
    questionCount.innerHTML = `Question ${quiz.currentQuestionIndex + 1} of ${
    ...
    question.choices.forEach((choice) => {
      ...
      btnLabel.innerHTML = choice;
      newRadioBtn.setAttribute("type", "radio");
      newRadioBtn.setAttribute("name", "choice");
      newRadioBtn.setAttribute("value", choice);
      ...
      choiceContainer.appendChild(newRadioBtn);
      choiceContainer.appendChild(btnLabel);
  ...
  function nextButtonHandler() {
    ...
    console.log("The answer===>", selectedAnswer, quiz.currentQuestionIndex)
